---
title: Faster builds with Turborepo and Stately
date: 2020-05-26
excerpt: In this session with Jared Palmer (Founder, Turborepo) and Matt Pocock (Developer Advocate, Stately), learn how using Turborepo with Vercel’s development and deployment platform leads to increased developer productivity and up to 85% faster build times.
tags:
  - alex
---
